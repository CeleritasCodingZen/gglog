// ============================================
// GGLOG — Discover: DiscoverNavbar
// ============================================
// Navbar variant with DISCOVER as the active link.
// Mirrors the pattern from ProfileNavbar exactly.
// ============================================
              ...
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  className={`
                    ...
                    transition-colors
                    ${link.active ? "text-lime" : "text-text-dim hover:text-lime"}
                  `}
                >
                  // {link.label}
                </Link>
